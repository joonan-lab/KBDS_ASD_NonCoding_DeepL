...
then
    echo "use_cuda: True"
    python /home/sonic/sei/sei-framework/workflow/script/vep_cli.py "$outdir/$vcf_basename" \
                                                                     $outdir \
                                                                     --genome=${hg_version} \
                                                                     --cuda
else
...
python /home/sonic/sei/sei-framework/workflow/script/sequence_class.py $outdir "$vcf_basename"

python /home/sonic/sei/sei-framework/workflow/script/sequence_max_class.py $outdir/sequence_class_scores.tsv $outdir